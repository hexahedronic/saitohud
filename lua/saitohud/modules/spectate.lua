...
local function HUDPaint()
	...
	draw.SimpleText(text, "Trebuchet24", ScrW() / 2 + 1, ScrH() * .8 + 1,
					Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	draw.SimpleText(text, "Trebuchet24", ScrW() / 2, ScrH() * .8,
...
if not Registry.Player._GetEyeTrace then Registry.Player._GetEyeTrace = Registry.Player.GetEyeTrace end
...
function Registry.Player:GetEyeTrace()
